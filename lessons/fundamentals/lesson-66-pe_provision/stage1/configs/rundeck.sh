...
#curl -vvv -X POST -H "Content-Type: application/json" -d {"name":"SATEC","config":{"project.label":"SATEC-label","resources.source.2.type":"file","resources.source.2.config.file":"/home/antidote/rundeckinventory.json","resources.source.2.config.format":"resourcejson"}} --cookie /home/antidote/rd_cookie "http://localhost:4440/${SYRINGE_FULL_REF}/api/32/projects"
curl -vvv -X POST -H "Content-Type: application/json" -d '{ "name": "SATEC", "config": { "project.label":"SATEC-label", "resources.source.2.type":"file", "resources.source.2.config.file":"/antidote/rundeck_config/rundeckinventory.json", "resources.source.2.config.format":"resourcejson" } }' --cookie /home/antidote/rd_cookie "http://localhost:4440/${SYRINGE_FULL_REF}/api/32/projects"
